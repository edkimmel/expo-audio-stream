...
class PipelineIntegration: PipelineListener {
    ...
    /// Binary twin of `pushAudioSync`: raw PCM16 LE bytes, no base64. The
    /// caller (module layer) has already copied the JS typed array into
    /// `Data`. Returns false on any failure.
